		...
		<div class="container">
			<div class="row">
				<form:form commandName="order" class="form-horizontal">
					<div
						class="well col-xs-10 col-sm-10 col-md-6 col-xs-offset-1 col-sm-offset-1 col-md-offest-3">
							...
							<table class="table table-hover">
								...
								<tbody>
									...
									<tr>
										...
										<td class="text-danger" style="text-align: center"><h4>
						...
						<button name="_eventId_backToCollectShippingDetail"
							class="btn btn-default">Back</button>
						| <input type="submit" value="Submit Order"
							class="btn btn-primary" name="_eventId_orderConfirmed" />|
